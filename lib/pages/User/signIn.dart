...
import 'package:learn_flower/pages/User/signup.dart';
                    ...
                    child: MaterialButton(
                      onPressed: () {
                        ...
                        if (_emailTextController.text.isEmpty) {
                          ...
                          db.signIn(_emailTextController.text,_passwordTextController.text ).then((value) => {
                            if(value==true){
                                ...
                                showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return const CustomDialogBox (
                                        ...
                                        descriptions: "Your Login is successful!",
                                        text: "ok",
                                      );
                                    })
                                    .whenComplete(() =>
                              ...
                              showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return const CustomDialogBox (
                                      ...
                                      descriptions: "Your Email or Password is inCorrect",
                                      text: "ok",
                                    );
                                  })
                                  .whenComplete(() =>
